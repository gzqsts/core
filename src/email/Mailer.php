...
use Gzqsts\Core\email\exception\Exception;
use Gzqsts\Core\email\exception\InvalidArgumentException;
...
class Mailer implements MessageWrapperInterface
{
    ...
    {
        $this->transport = $param['mailer'];
        $this->debug     = isset($param['debug']) ? $param['debug'] : false;
        $this->from      = [$param['from']['address'] => $param['from']['name']];
